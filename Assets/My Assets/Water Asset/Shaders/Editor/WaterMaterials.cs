...
internal class WaterMaterials : MaterialEditor
{    
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class SimpleWaterShaderEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        WaterMaterials.DrawUILine(bgLineColor, 2, bgLinePadding);

        //--------------

        EditorGUILayout.LabelField("Albedo Movement:", EditorStyles.boldLabel);
        WaterMaterials.DrawUILine(smLineColor, 1, smLinePadding);
